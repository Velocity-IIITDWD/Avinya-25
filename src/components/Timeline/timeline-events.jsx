                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <motion.div className="flex items-center gap-3 mb-4" variants={itemVariants}>
                                <div className="p-2 bg-white rounded-lg text-black shadow-lg">{event.icon}</div>
                                ...
                                >
                                    {event.time && (
                                        <p className="text-sm text-gray-400">
                                            <span className="font-semibold text-gray-200">Time:</span> {event.time}
                                        </p>
                                    )}
                                    {event.venue && (
                                        <p className="text-sm text-gray-400">
                                            <span className="font-semibold text-gray-200">Venue:</span> {event.venue}
                                        </p>
                                    )}
                                </motion.div>
                            )}

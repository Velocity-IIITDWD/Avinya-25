...
const timelineData = [
    ...
    // ===== Nov 7, 2025 =====
    {
        ...
        date: "Nov 7, 2025",
        title: "Tech Odyssey",
        subtitle: "Full-Day Tech Events",
        description:
            "A day dedicated to innovation — featuring RTL2GDSII competition, startup conclave, and engaging tech challenges.",
        icon: <Zap className="w-6 h-6" />,
        time: "10:00 am - 6:00 pm",
        venue: "M Block, PI Block, 240 Seater",
    },
    {
        id: 5,
        date: "Nov 7, 2025",
    ...
    // ===== Nov 8, 2025 =====
    {
        ...
        date: "Nov 8, 2025",
        title: "Mega Rush",
        subtitle: "Full-Day Fest Finale",
        description:
            "Experience the grand finale with Mega Rush, Cyber Workshop, and ML to FPGA implementation sessions.",
        icon: <Zap className="w-6 h-6" />,
        time: "10:00 am - 6:00 pm",
        venue: "M Block, 240 & 120 Seater, Presentation Room 2, E Block Classrooms",
    },
    {
        id: 15,
        date: "Nov 8, 2025",
